...
const regions = [
  {
    name: "Kanto",
    description:
      "The original region, home of Pikachu and the first 151 Pokémon.",
  },
  {
    name: "Johto",
    description:
      "Introduced in Generation II, known for Lugia, Ho-Oh, and new evolutions.",
  },
  {
    name: "Hoenn",
    description:
      "A tropical region with vast oceans and powerful Pokémon like Kyogre and Groudon.",
  },
  {
    name: "Sinnoh",
    description:
      "A snowy, mountainous region with deep legends and Pokémon like Dialga and Palkia.",
  },
  {
    name: "Unova",
    description:
      "Inspired by New York, this region introduces a completely new Pokédex.",
  },
  {
    name: "Kalos",
    description:
      "French-inspired region that introduced mega-evolutions and Greninja.",
  },
  {
    name: "Alola",
    description:
      "Hawaiian-style islands with regional Pokémon forms and island challenges.",
  },
  {
    name: "Galar",
    description:
      "A UK-inspired region with Dynamax battles and a strong league system.",
  },
  {
    name: "Paldea",
    description:
      "The newest region (Gen 9), a fully open-world experience from Scarlet & Violet.",
  },
];
...
export default function RegionsPage() {
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-green-50 to-blue-50 text-gray-800">
      {/* Header */}
      <header className="bg-green-300 p-6 shadow-lg">
      ...
      <main className="flex-grow p-8">
        <section className="max-w-4xl mx-auto mb-10 text-center">
          ...
          <p className="text-gray-700 leading-relaxed">
            Every region has its own unique Pokémon species, cities, and lore.
            Trainers explore these lands, conquer gyms, and aim to become
            Pokémon Champions. Discover the history of each region below!
          </p>
        </section>
        <section className="max-w-4xl mx-auto mb-10 text-center">
      ...
      <footer className="bg-gray-900 text-white text-center p-4 mt-12 text-sm">
        ...
        project and is not affiliated with Nintendo, Game Freak, or The Pokémon
        Company.
      </footer>
    </div>
  );
