...
export default function Home() {
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-blue-50 to-yellow-50 text-gray-800">
      {/* Header */}
      <header className="bg-yellow-300 p-6 shadow-lg">
        <h1 className="text-4xl font-extrabold text-center text-red-600 drop-shadow-md">
          Welcome to Pokémon World
        </h1>
        <p className="text-center text-gray-700 mt-2">
          Explore iconic Pokémon, their types, regions, and history
        </p>
      ...
      <main className="flex-grow p-8">
        <section className="max-w-4xl mx-auto mb-10">
          ...
          <p className="mb-4 text-gray-700 leading-relaxed">
            Pokémon, short for “Pocket Monsters,” is a Japanese franchise
            created by Satoshi Tajiri in 1996. It started as a Game Boy game
            developed by Game Freak and published by Nintendo. Since then, it
            has become one of the most successful franchises globally, spanning
            video games, trading card games, animated series, movies, and
            merchandise.
          </p>
          <p className="mb-4 text-gray-700 leading-relaxed">
            Trainers from different regions capture and train Pokémon for
            battles, competitions, and companionship. Each Pokémon belongs to
            one or more elemental types such as Water, Fire, Grass, Electric,
            and Ghost, which define their strengths and weaknesses in battles.
          </p>
        </section>
