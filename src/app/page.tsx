  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-blue-50 to-yellow-50 text-gray-800">
      ...
      <header className="bg-yellow-300 p-6 shadow-lg">
        <h1 className="text-4xl font-extrabold text-center text-red-600 drop-shadow-md">Welcome to Pokémon World</h1>
        <p className="text-center text-gray-700 mt-2">Explore iconic Pokémon, their types, regions, and history</p>
      </header>
      ...
      <footer className="bg-gray-900 text-white text-center p-4 mt-12 text-sm">
        &copy; 2025 Pokémon Fan Project. This website is a fan-made educational project and is not affiliated with Nintendo,
